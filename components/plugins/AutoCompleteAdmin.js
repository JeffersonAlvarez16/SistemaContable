        ...
        return (
            ...
            <div  >
                <TextField
                    id={id}
                    variant="contained"
                    error={itemCategoria ? itemCategoria.nombre.length > 0 ? false : true : true}
                    value={`${itemCategoria ? itemCategoria.nombre : ''}`}
                    onChange={(event) => {
                ...
                <Popper open={open} anchorEl={anchorEl} transition style={{ zIndex: 9999, minWidth: 350 }} >
                    {({ TransitionProps }) => (
                                    ...
                                    <Toolbar>
                                        <Tooltip title="Seleccionar" placement="top">
                                            <IconButton color="primary" onClick={() => {
                                                this.props.changueText(dataAuto.filter(item => item.id === checkedKey)[0])
